  ...
  return (
    <section ref={ref} className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-slate-800 via-indigo-900 to-slate-800">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-black mb-6 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent leading-tight pb-4" style={{ paddingBottom: '0.5rem', lineHeight: '1.15' }}>
            Tính năng nổi bật
          </h2>
